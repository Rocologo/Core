...
public class Tools {
	...
	public static double round(double d) {
		return Math.round(d / BagOfGoldCore.getInstance().getConfigManager().rewardRounding)
				* BagOfGoldCore.getInstance().getConfigManager().rewardRounding;
	}

	public static double ceil(double d) {
		return Math.ceil(d / BagOfGoldCore.getInstance().getConfigManager().rewardRounding)
				* BagOfGoldCore.getInstance().getConfigManager().rewardRounding;
	}

	public static double floor(double d) {
		return Math.floor(d / BagOfGoldCore.getInstance().getConfigManager().rewardRounding)
				* BagOfGoldCore.getInstance().getConfigManager().rewardRounding;
	}
