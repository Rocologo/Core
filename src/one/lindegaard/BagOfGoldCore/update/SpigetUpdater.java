package one.lindegaard.BagOfGoldCore.update;
...
public class SpigetUpdater {
	...
	public SpigetUpdater(BagOfGoldCore plugin) {
		this.plugin = plugin;
	}
	...
	public void hourlyUpdateCheck(final CommandSender sender, boolean updateCheck, final boolean silent) {
		long seconds = BagOfGoldCore.getInstance().getConfigManager().checkEvery;
		if (seconds < 900) {
